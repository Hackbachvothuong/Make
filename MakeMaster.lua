...
function topos(...)
    ...
    local s, e = pcall(function()
        if Local_Player.Character:FindFirstChild("HumanoidRootPart") and tick() - recentlySpawn > 5 then
            if Local_Player.Character:FindFirstChild("HumanoidRootPart") and not Raiding() and _G.ResetTP then
                ...
                if nearest and (charDist <= 9200) then
                    ...
                    repeat wait(0.1) until Local_Player.Character.HumanoidRootPart.Parent
                end
            end
        end
...
MobCakePrince = Main:AddParagraph({
...
Toggle = Weapon:AddToggle("MyToggle", {Title = "Đổi Sever Đánh Elite Hunter", Default = _G.AutoEliteHunterHop })
Toggle:OnChanged(function(Value)
